...
def _preprocess_input(owner, e):
    if e[0] != 'INPUT':
        return
    ev = e[1]
    if ev.type == SDL_KEYDOWN and ev.key == SDLK_SPACE:
        owner.jump_buffer_timer = owner.JUMP_BUFFER
        owner.jump_consumed = False
